...
<body>
  ...
  <ul id="menu">
    ...
    <li><a href="/internship_blog/about/">
        About
      </a>
    </li>
    <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == 1) : ?>
      <li><a href="/internship_blog/inc/update.inc.php?action=logout">
          Log Out!
        </a>
      </li>
      <li><a href="/internship_blog/admin/create_user">
          Add admin
        </a>
      </li>
  ...
  <div id="entries">
    ...
    // If the full display flag is 0, format linked entry titles.
      ...
      foreach ($entries as $entry) {
        ...
        ?>
        <p>
          <a href="/internship_blog/<?php echo $entry['page'] ?>/<?php
          echo $entry['url'] ?>" >
