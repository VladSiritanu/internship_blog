<?php
    ...
    class Comments
    {
        ...
        //An array for containig the entries
        public $comments;
        ...
        public  function showCommentForm($blog_id)
        {
            $errors = array(
                ...
                3 => '<p class="error">Pleas answer the anti-spam Question correctly!</p>'
            );
...
FORM;
        ...
        public function showComments($blog_id)
        {
            ...
            //Loo[ through the stored comments
            foreach($this->comments as $comm)
            {
                ...
                if(!empty($comm['comm_date']) && !empty($comm['comm_name']))
                {
                    ...
                    $byline = "<span><strong>$comm[comm_name]</strong>
                                [Posted on $date]</span>";
                ...
                $display .= "
                <p class=\"comment\">$byline$comm[comm_text]$admin</p>";
            }
